    ...
    return (
        <>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <TouchableOpacity activeOpacity={0.8} onPress={() => setSelectedUser(item)} style={{ width: '90%', borderRadius: 20, flexDirection: 'row', alignItems: 'center', elevation: 2, padding: 20, alignSelf: 'center', backgroundColor: '#fff', marginBottom: 20 }}>
                        <View>
